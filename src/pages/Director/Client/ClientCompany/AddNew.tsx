...
const FormIndividual = () => {
    ...
    // dynamic form 
    const [fields, setFields] = useState([{ name: '', address: '', email: '', gender: '', dateOfBirth: '', placeOfBirth: '', pan: '' }]);
    ...
    const handleAddField = () => {
        setFields([...fields, { name: '', address: '', email: '', gender: '', dateOfBirth: '', placeOfBirth: '', pan: '' }]);
    };
