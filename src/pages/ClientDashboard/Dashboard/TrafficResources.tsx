...
const TrafficResources = () => {
    return (
        <React.Fragment>
            <div className="col-span-12 2xl:col-span-4 w-3/4">
                <div className="grid grid-cols-12 gap-x-3">
                    <div className="col-span-6 card col-span-6 2xl:col-span-3">
                        <div className="card-body">
                            <div className="flex items-center mb-3">
                                <h6 className="grow text-15">Priority Tasks Summarry</h6>
