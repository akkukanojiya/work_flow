...
// Icon
import { MoreHorizontal, Eye, FileEdit, Trash2, Search, Plus, Download, Pencil, EyeIcon } from 'lucide-react';
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            cell: (cell: any) => (
                ...
                <Link to="/company-Support-form" className="flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 dark:bg-zink-600 dark:text-zink-200 text-slate-500 hover:text-custom-500 dark:hover:text-custom-500 hover:bg-custom-100 dark:hover:bg-custom-500/20" ><Pencil className="size-4" /></Link>
                ...
                <div className="card-body">
                    <div  className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
                        ...
                        <div className="w-full md:w-auto flex-shrink-0 flex space-x-4">
                            ...
                            <Link to="/company-multi-form" type="button" className="text-white btn bg-[#25476a] border-[#2a5179] hover:text-white hover:bg-[#2a5179] hover:border-[#2a5179] focus:text-white focus:bg-[#2a5179] focus:border-[#2a5179] focus:ring focus:ring-[#2a5179] active:text-white active:bg-[#25476a] active:border-[#25476a] active:ring active:ring-[#2a5179] dark:ring-[#2a5179]"><Plus className="inline-block size-4" /> <span className="align-middle">Add Clients</span></Link>
                        </div>
                    </div>
                </div>
