...
const Authorised_Person = () => {
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Authorised Person List ' pageTitle='Authorised Person' />
            ...
            <div>
                ...
                />
                            ...
                            >
                                <Plus className="inline-block size-4" /> <span className="align-middle">Add Authorised Person</span>
                            </Link>
                        </div>
                    </div>
...
export default Authorised_Person;