...
import { BadgeCheck, Dribbble, Facebook, Github, Globe, ImagePlus, Instagram, Linkedin, Mail, MapPin, MoreHorizontal, Plus, UserCircle, Twitter, PhoneCall } from "lucide-react";
            ...
            <div className={className}>
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                    ...
                    <div className="lg:col-span-10 2xl:col-span-9">
                        <h5 className="mb-1">Tech Creature Solution <BadgeCheck className="inline-block size-4 text-sky-500 fill-sky-100 dark:fill-custom-500/20"></BadgeCheck></h5>
                        ...
                        <div className="flex gap-3 mb-4">
                            <p className="text-slate-500 dark:text-zink-200"><Mail className="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></Mail>techcreaturesolution@gmail.com</p>
                             
                        </div>

                        <div className="flex gap-3 mb-4">
                            <p className="text-slate-500 dark:text-zink-200"><PhoneCall className="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></PhoneCall>+91 9327748151</p>
