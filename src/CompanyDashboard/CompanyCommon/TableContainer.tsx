          ...
          <div className={PaginationClassName}>
            ...
            <ul className="flex flex-wrap items-center gap-2 shrink-0">
              <li>
                <Link
                  to="#!"
                  className={`inline-flex items-center justify-center bg-[#25476a] dark:bg-[#25476a] h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-white dark:text-white hover:text-black dark:hover:text-black hover:bg-custom-50 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-white dark:[&.active]:text-white [&.active]:bg-[#25476a] dark:[&.active]:bg-[#25476a] [&.active]:border-[#25476a] dark:[&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto ${!getCanPreviousPage() && "disabled"
                    }`}
                  onClick={previousPage}
                >
                  <ChevronLeft className="size-4 mr-1 rtl:rotate-180"></ChevronLeft> Prev
                </Link>
              </li>
              {getPageOptions().map((item: any, key: number) => (
                <React.Fragment key={key}>
                  <li>
                    <Link
                      to="#"
                      className={`inline-flex items-center justify-center bg-[#25476a] dark:bg-[#25476a] size-8 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-white dark:text-white hover:text-black dark:hover:text-black hover:bg-custom-100 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-white dark:[&.active]:text-white [&.active]:bg-[#25476a] dark:[&.active]:bg-[#25476a] [&.active]:border-[#25476a] dark:[&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto ${getState().pagination.pageIndex === item && "active"
                        }`}
              ...
              <li>
                <Link
                  to="#!"
                  className={`inline-flex items-center justify-center bg-[#25476a] dark:bg-[#25476a] h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-white dark:text-white hover:text-black dark:hover:text-black hover:bg-custom-50 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-white dark:[&.active]:text-white [&.active]:bg-[#25476a] dark:[&.active]:bg-[#25476a] [&.active]:border-[#25476a] dark:[&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto ${!getCanNextPage() && ""
                    }`}
                  onClick={() => getCanNextPage() && nextPage()}
                >
                  Next <ChevronRight className="size-4 ml-1 rtl:rotate-180"></ChevronRight>
                </Link>
              </li>
            </ul>
          </div>
