          ...
          <div className={PaginationClassName}>
            ...
            <ul className="flex flex-wrap items-center gap-2 shrink-0">
              <li>
                <Link
                  to="#!"
                  className={`inline-flex items-center justify-center bg-[#25476a] dark:bg-[#25476a] h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zinc-500 text-white dark:text-white hover:text-black dark:hover:text-black hover:bg-[#25476a] focus:bg-[#25476a] focus:text-white [&.active]:text-white dark:[&.active]:text-white [&.active]:bg-[#25476a] [&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zinc-300 [&.disabled]:cursor-auto ${!getCanPreviousPage() && "disabled"}`}
              ...
              {getPageOptions().map((item, key) => (
                <React.Fragment key={key}>
                  <li>
                    <Link
                      to="#"
                      className={`inline-flex items-center justify-center bg-white dark:bg-zinc-700 size-8 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zinc-500 text-slate-500 dark:text-zinc-200 hover:text-[#25476a] dark:hover:text-[#25476a] hover:bg-custom-100 dark:hover:bg-[#25476a] focus:bg-[#25476a] focus:text-white [&.active]:text-white dark:[&.active]:text-white [&.active]:bg-[#25476a] [&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zinc-300 [&.disabled]:cursor-auto ${getState().pagination.pageIndex === item && "active"}`}
              ...
              <li>
                <Link
                  to="#!"
                  className={`inline-flex items-center justify-center bg-white dark:bg-zinc-700 h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zinc-500 text-slate-500 dark:text-zinc-200 hover:text-[#25476a] dark:hover:text-[#25476a] hover:bg-custom-50 focus:bg-[#25476a] focus:text-white [&.active]:text-white [&.active]:bg-[#25476a] [&.active]:border-[#25476a] [&.disabled]:text-slate-400 dark:[&.disabled]:text-zinc-300 [&.disabled]:cursor-auto ${!getCanNextPage() && "disabled"}`}
