                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <div className="mt-8 text-center">
                            ...
                            <p className="text-slate-500 dark:text-zink-200">Get your free OffiQuick account now</p>
                        </div>
                        ...
                        <form action="/" className="mt-10" id="registerForm"
                            ...
                            <div className="mt-10 text-center">
                                <p className="mb-0 text-slate-500 dark:text-zink-200">Already have an account ? <Link to="/director-login" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500">Login</Link> </p>
                            </div>
                        </form>
                    </div>
                </div>
