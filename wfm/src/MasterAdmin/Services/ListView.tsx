...
const SubServices = () => {
    ...
    const validation: any = useFormik({
        ...
        initialValues: {
            ...
            subservices: (eventData && eventData.subservices) || '',
        ...
        validationSchema: Yup.object({
            ...
            subservices: Yup.string().required("Please Enter Sub Services"),
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Sub Service List' pageTitle='SubServices' />
                    ...
                    <div className="card" id="usersTable">
                        <div className="card-body">
                            ...
                            <form action="#!">
                                ...
                                {/* <h6 className="text-15 grow">Sub Service List</h6> */}
                                ...
                                <button className="bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zinc-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20" onClick={generateExcel}>
                                    ...
                                    <button type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20" onClick={toggle}><Plus className="inline-block size-4" /> <span className="align-middle">Add Sub Service</span></button>
                                </div>
                            </div>
                        </div>
                        {/* <div className="!py-2.1 card-body border-y border-dashed border-slate-200 dark:border-zink-500">
                            <form action="#!">
                                <div className="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                    <div className="relative xl:col-span-3">
            ...
            <Modal show={show} onHide={toggle} id="defaultModal" modal-center="true"
                ...
                <Modal.Header className="flex items-center justify-between p-4 border-b dark:border-zink-300/20"
                    ...
                    <Modal.Title className="text-16">{!!isEdit ? "Edit Sub Service" : "Add Sub Service"}</Modal.Title>
                </Modal.Header>
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="mb-3">
                            ...
                            {validation.touched.services && validation.errors.services ? (
                                <p className="text-red-400">{validation.errors.services}</p>
                            ) : null}
                        </div>
                        <div className="mb-3">
                            <label htmlFor="subservicesInput" className="inline-block mb-2 text-base font-medium">Sub Services*</label>
                            <input type="text" id="servicesInput" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Sub Services"
                                name="subservices"
                                onChange={validation.handleChange}
                                value={validation.values.subservices || ""}
                            />
                            {validation.touched.subservices && validation.errors.subservices ? (
                                <p className="text-red-400">{validation.errors.subservices}</p>
                            ) : null}
                        </div>
                        {/* <div className="mb-3">
                        ...
                        <div className="flex justify-end gap-2 mt-4">
                            ...
                            <button type="submit" className="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                {!!isEdit ? "Update Sub Service" : "Add Sub Service"}
                            </button>
                        </div>
                    </form>
                </Modal.Body>
