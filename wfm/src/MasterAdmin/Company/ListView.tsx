...
const MasterCompany = () => {
    ...
    const validation: any = useFormik({
        ...
        initialValues: {
            ...
            confirmpassword: (eventData && eventData.confirmpassword) || '',
                ...
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" id="passwordInput" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Your Password"
                                name="password"
                                onChange={validation.handleChange}
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" id="confirmPasswordInput" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Your confirm Password"
                                name="confirmPassword"
                                onChange={validation.handleChange}
                                value={validation.values.confirmpassword || ""}
                            />
                            {validation.touched.confirmpassword && validation.errors.confirmpassword ? (
                                <p className="text-red-400">{validation.errors.confirmpassword}</p>
                            ) : null}
                        </div>
                        <div className="mb-3">
