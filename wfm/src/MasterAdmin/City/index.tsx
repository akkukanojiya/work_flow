...
const Citys = () => {
    ...
    const filterSearchData = (e: any) => {
        ...
        const keysToSearch = ['name', 'designation', 'city', 'email', 'status'];
        ...
        <React.Fragment>
            ...
            <Modal show={show} onHide={toggle} id="defaultModal" modal-center="true"
                ...
                <Modal.Header className="flex items-center justify-between p-4 border-b dark:border-zink-300/20"
                    ...
                    <Modal.Title className="text-16">{!!isEdit ? "Edit City" : "Add City"}</Modal.Title>
                </Modal.Header>
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    ...
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-input border-slate-300 focus:outline-none focus:border-custom-500" data-choices data-choices-search-false id="country"
                                name="country"
                                onChange={validation.handleChange}
                        ...
                        <div className="mb-3">
                            <label htmlFor="statusSelect" className="inline-block mb-2 text-base font-medium">State*</label>
                            <select className="form-input border-slate-300 focus:outline-none focus:border-custom-500" data-choices data-choices-search-false id="state"
                                name="state"
                                onChange={validation.handleChange}
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" id="city" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="City"
                                name="city"
                                onChange={validation.handleChange}
