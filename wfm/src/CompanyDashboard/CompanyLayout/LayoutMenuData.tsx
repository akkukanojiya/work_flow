import { MessageSquare, MonitorDot, ScrollText, Boxes, Building2, ListTodoIcon, User2Icon, Users2, FileClockIcon, FileStackIcon, Landmark, GraduationCap, UserPlus2, UserCircle2Icon, LucideScreenShareOff, LucideNotebookPen, LucideUserRoundPlus, LucideBuilding2, UserCircleIcon, UserCheck } from "lucide-react";
                ...
                subItems: [
                    {
                        ...
                        icon: <FileStackIcon />,
                        link: '/company-report-company',
                        parentId: 'companyreport',
                    },
                    {
                        id: 'report',
                        label: 'Individual Report',
                        icon: <FileStackIcon />,
                        link: '/company-report-individual',
                        parentId: 'companyreport',
                    },
                    {
                        id: 'report',
                        label: 'Proprietor Report',
                        icon: <FileStackIcon />,
                        link: '/company-report-proprietor',
                        parentId: 'companyreport',
                    },
                    {
                        id: 'report',
                        ...
                        icon: <FileStackIcon />,
                        link: '/company-report-partnership',
                        parentId: 'companyreport',
                    },
                    {
                        id: 'report',
                        label: 'Trust/AOP Report',
                        icon: <FileStackIcon />,
                        link: '/company-report-trustAop',
                        parentId: 'companyreport',
                    },
                    {
                        id: 'report',
...
//             id: 'individual',
//             label: 'Individual',
//             link: '/apps-ecommerce-ClientCompany-list',
//             parentId: 'Client',
//         },
//         {
//             id: 'company',
