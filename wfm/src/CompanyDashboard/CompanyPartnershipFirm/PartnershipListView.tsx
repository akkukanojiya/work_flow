...
const CompanyPartner = () => {
    ...
    const columns = useMemo(() => [
        ...
        // },
        {
            header: "Partnership Firm Name",
            accessorKey: "partnershipName",
            enableColumnFilter: false,
            enableSorting: true,
            cell: (cell: any) => (
        ...
        {
            header: "Partnership Firm Category",
            accessorKey: "partnershipFirmCategory",
            enableColumnFilter: false,
            // cell: (cell: any) => (
        ...
        {
            header: "Partnership Firm GST No.",
            accessorKey: "partnershipFirmGstNo",
            enableColumnFilter: false,
            enableSorting: true,
        },
        // {
            ...
            cell: (cell: any) => (
                <Dropdown className="relative dropdown">
                    ...
                    <Dropdown.Content placement={cell.row.index ? "top-end" : "right-end"} className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="productAction1">
                        ...
                        <li>
                            <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" to="/director-formindividual-client"><FileEdit className="inline-block size-3 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">Edit</span></Link>
                        </li>
                        <li>
    ...
    return (
        <React.Fragment>
            <BreadCrumb title=' Partnership Firm List' pageTitle='PartnershipFirm' />
            ...
            <div className="card" id="productListTable">
                <div className="card-body">
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div className="lg:col-span-2 ltr:lg:text-right rtl:lg:text-left xl:col-span-6 xl:col-start-11">
                            <Link to="/company-partnershipfirm-form" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><Plus className="inline-block size-4" /> <span className="align-middle">Add Partnership Firm</span></Link>
                        </div>
                    </div>
                </div>
