...
const EmployeeListView = () => {
    ...
    const validation: any = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            employeedesignation: Yup.string().required("Please Enter Employee Designation"),
            // location: Yup.string().required("Please Enter Location"),
            employeemail: Yup.string().required("Please Enter Employee Email"),
            employeecity: Yup.string().required("Please Enter Employee City"),
            employeestate: Yup.string().required("Please Enter Employee State"),
            pincode: Yup.string().required("Please Enter Employee pincode"),
            role: Yup.string().required("Please Enter Employee Role"),
            shift: Yup.string().required("Please Enter Employee Shift"),
            ...
            bloodGroup: Yup.string().required("Please blood Group "),
        }),
            ...
            <Modal show={show} onHide={toggle} id="defaultModal" modal-center="true"
                ...
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="mb-3">
                            <label htmlFor="userNameInput" className="inline-block mb-2 text-base font-medium">Employee Name</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="phoneNumberInput" className="inline-block mb-2 text-base font-medium">Employee Mobile No</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="phoneNumberInput" className="inline-block mb-2 text-base font-medium">Emergency Contact No</label>
