    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                'vertical-menu-item-hover': colors.blue[800],
                'vertical-menu-item-bg-hover': colors.blue[50],
                'vertical-menu-item-active': colors.blue[800],
                'vertical-menu-item-bg-active': colors.blue[50],
                'vertical-menu-sub-item': colors.slate[400],
                'vertical-menu-sub-item-hover': colors.blue[800],
                'vertical-menu-sub-item-active': colors.blue[800],
                ...
                'vertical-menu-sub-item-hover-dark': colors.blue[800],
