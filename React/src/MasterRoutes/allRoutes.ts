...
import Country from "MasterAdmin/Country";
import State from "MasterAdmin/States/ListView";
import City from "MasterAdmin/City";
...
const authProtectedRoutes: Array<RouteObject> = [
  ...
  { path: "/master-admin-country", component: Country },
  { path: "/master-admin-state", component: State },
  { path: "/master-admin-city", component: City },
