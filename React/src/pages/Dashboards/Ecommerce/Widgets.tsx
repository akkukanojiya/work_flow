...
import { ListChecksIcon, BookOpenCheck, ShieldAlert, Loader, ListPlus, MessageCircleOff} from 'lucide-react';
            ...
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <h5 className="mt-4 mb-2">$
                        ...
                        k</h5>
                    <p className="text-slate-500 dark:text-zink-200">Total Task</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <p className="text-slate-500 dark:text-zink-200"> Assigned Task</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <p className="text-slate-500 dark:text-zink-200">New Task</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <p className="text-slate-500 dark:text-zink-200">Close Task</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <h5 className="mt-4 mb-2"><CountUp end={3519} className="counter-value" /></h5>
                    <p className="text-slate-500 dark:text-zink-200">Due Task</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <h5 className="mt-4 mb-2"><CountUp end={3519} className="counter-value" /></h5>
                    <p className="text-slate-500 dark:text-zink-200">Panding Task</p>
                </div>
            </div>
        </React.Fragment>
    );
