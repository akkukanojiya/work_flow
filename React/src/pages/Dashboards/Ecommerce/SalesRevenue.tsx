...
import {CalendarRange ,Loader,ListChecks} from 'lucide-react';
            ...
            <div className="col-span-12 card 2xl:col-span-8">
                <div className="card-body">
                    <div className="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                        <h6 className="grow text-15">Tasks Summary</h6>
                    ...
                    <div className="grid grid-cols-12 gap-4 mb-3">
                        <div className="col-span-12 md:col-span-6 lg:col-span-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="grow">
                                    <p className="mb-1 text-slate-500 dark:text-zink-200">Total Tasks</p>
                        ...
                        <div className="col-span-12 md:col-span-6 lg:col-span-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="grow">
                                    <p className="mb-1 text-slate-500 dark:text-zink-200">Panding Task  </p>
