import { Award, CalendarDays, CircuitBoard, Codesandbox, FileText, LifeBuoy, LocateFixed, Mail, Map, MessageSquare, MonitorDot, PackagePlus, PictureInPicture2, PieChart, RadioTower, ScrollText, Share2, ShoppingBag, Table, Trophy, UserRound,Boxes, Building2, User2Icon } from "lucide-react";
    ...
    },
    {
        ...
        subItems: [
                
            {
                ...
                label: 'Individual',
                link: '/company-client-individual',
                parentId: 'Client',
            },
            {
                id: 'company',
                label: 'Company',
                link: '/company-client-client',
                parentId: 'Client',
            },
        ]
    },
